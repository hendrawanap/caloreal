...
<div class="bg-ternary">
  <div class="container mx-auto pt-20 pb-44">
    ...
    <a href="{{route('bmr.index')}}" class="border-2 rounded-xl border-black bg-primary px-9 py-2 text-white text-lg">Hitung Sekarang</a>
  </div>
</div>
<div class="container mt-10 mb-24 mx-auto max-w-6xl">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-16 gap-y-10">
    @for ($i = 0; $i < 4; $i++)
